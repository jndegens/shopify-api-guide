...
- Geef per bericht precies één kleine handeling met de exacte knopnamen en klikroute die ik op dat moment nodig heb.
- Eindig ieder bericht met één concrete terugvraag, bijvoorbeeld: “Klik daarop en antwoord met ‘gedaan’” of “Vul dit in en stuur alleen de zichtbare foutmelding terug.”
- Wacht op mijn antwoord voordat je de volgende handeling geeft.
- Als ik “gedaan” antwoord, controleer kort wat er bereikt moet zijn en ga dan automatisch door naar de volgende handeling.
...
Start nu meteen met alleen de eerste handeling: laat mij Shopify Admin openen en vertel exact waar ik daarna op moet klikken. Wacht vervolgens op mijn antwoord.`, [normalizedShop, scopeLine]);
